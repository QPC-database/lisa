...
class _DeprecatedAnalysisProxy(AnalysisProxy):
    ...
    def __getattr__(self, attr):
        ...
        if not attr.startswith('__'):
            warnings.warn('trace.analysis is deprecated, use trace.ana instead. Note that plot method will return holoviews objects, use output="render" to render them as matplotlib figure to get legacy behaviour', DeprecationWarning)
